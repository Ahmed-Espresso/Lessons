...
const advancedChatUtils = {
    ...
    createMessageElement: function(msg) {
        ...
        // إضافة "(أنت)" إذا كان المستخدم الحالي هو المرسل
        if (isCurrentUser) {
        ...
        // بناء محتوى الرسالة حسب المستخدم
        if (isCurrentUser) {
            // رسالة المستخدم الحالي (على اليمين)
            messageDiv.innerHTML = `
                <div class="message-inner">
                    <div class="message-header">
                        <div class="message-time-header">${time}</div>
